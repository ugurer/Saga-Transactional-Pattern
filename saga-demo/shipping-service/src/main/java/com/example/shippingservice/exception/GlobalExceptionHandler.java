...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleInvalidShipmentStateException(
            InvalidShipmentStateException ex, WebRequest request) {
        return buildErrorResponse(ex.getMessage(), HttpStatus.CONFLICT, request);
    }

    @ExceptionHandler(ShipmentException.class)
    public ResponseEntity<Object> handleShipmentException(
            ShipmentException ex, WebRequest request) {
